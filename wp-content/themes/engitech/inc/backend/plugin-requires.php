...
function engitech_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            'name'               => esc_html__( 'OT Portfolio', 'engitech' ), 
            'slug'               => 'ot_portfolio', 
            'source'             => esc_url($protocol.'://oceanthemes.s3.amazonaws.com/plugins/ot_portfolio.zip'), 
            'required'           => false, 
        ),
        array(            
            'name'               => esc_html__( 'Revolution Slider', 'engitech' ), 
            'slug'               => 'revslider', 
            'source'             => esc_url($protocol.'://oceanthemes.s3.amazonaws.com/plugins/revslider.zip'),
            'required'           => false, 
            'version'            => '6.6.1', 
        ...
        array(            
            'name'               => esc_html__( 'OT One Click Demo Content', 'engitech' ), 
            'slug'               => 'soo-demo-importer', 
            'source'             => esc_url($protocol.'://oceanthemes.s3.amazonaws.com/plugins/soo-demo-importer.zip'), 
            'required'           => false, 
        ),
	);
	$config  = array(
